...
const definitions = [
  ...
  { category: "Performance & UX", entries: [
    { term: "Fast shield/unshield", def: "How quickly a user can move between public and private states. STRK20: ~2s block + sub-5s proof in the current backend-prover fast path; client-side/mobile proving is roadmap. Zcash: ~75s block bottleneck. Monero: always private, no opt-out. Aztec: ~6s blocks in Alpha Mainnet (since March 31, 2026). Midnight uses client-side proving on a roughly 6-second block cadence, but no official mainnet shield/unshield benchmark is published. Railgun: 1-hour mandatory standby (PPOI). Solana: feature disabled. Zama: FHE much slower." },
