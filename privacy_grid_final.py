...
# Features:                            multi  fZK  secr  disc  comp  noTS    PQ  succ  shld  fast  scal  rich  DeFi  ecos   EVM    AA    HW
# Groups:                              |---- privacy model ----|  |-- crypto foundation --|  |---- performance & UX ----|  |-- ecosystem & access --|
projects = [
    ("STRK20s (Starknet)", [True, False, True, True, True, True, True, True, True, True, True, True, True, True, False, True, False], True, {}),
...
for row_idx, (name, ticks, is_starknet, fn_map) in enumerate(projects):
    ...
    for col_idx, has_tick in enumerate(ticks):
        ...
        if has_tick is True:
            ...
            fn_num = fn_map.get(col_idx, "")
            superscripts = {1: "\u00B9", 2: "\u00B2", 3: "\u00B3", 4: "\u2074", 5: "\u2075", 6: "\u2076", 7: "\u2077", 8: "\u2078", 9: "\u2079", 10: "\u00B9\u2070", 11: "\u00B9\u00B9", 12: "\u00B9\u00B2", 13: "\u00B9\u00B3", 14: "\u00B9\u2074", 15: "\u00B9\u2075", 16: "\u00B9\u2076", 17: "\u00B9\u2077", 18: "\u00B9\u2078", 19: "\u00B9\u2079", 20: "\u00B2\u2070", 21: "\u00B2\u00B9", 22: "\u00B2\u00B2", 23: "\u00B2\u00B3"}
...
superscripts_display = {1: "\u00B9", 2: "\u00B2", 3: "\u00B3", 4: "\u2074", 5: "\u2075", 6: "\u2076", 7: "\u2077", 8: "\u2078", 9: "\u2079", 10: "\u00B9\u2070", 11: "\u00B9\u00B9", 12: "\u00B9\u00B2", 13: "\u00B9\u00B3", 14: "\u00B9\u2074", 15: "\u00B9\u2075", 16: "\u00B9\u2076", 17: "\u00B9\u2077", 18: "\u00B9\u2078", 19: "\u00B9\u2079", 20: "\u00B2\u2070", 21: "\u00B2\u00B9", 22: "\u00B2\u00B2", 23: "\u00B2\u00B3"}
...
definitions = [
    ...
    ("Compliance (viewing keys)", "auditing entity can trace a specific user\u2019s history without affecting others. STRK20s has third-party viewing keys. Zcash has full incoming/outgoing viewing keys. Aztec has incoming + outgoing viewing key pairs. Aleo has view keys plus Selective Disclosure and zPass for identity proofs. Railgun has scoped viewing keys (by block range) plus PPOI plus Koinly tax exports. Canton has sub-transaction privacy with full auditability and GDPR compliance built into Daml contracts (strongest institutional compliance story). Solana has auditor_elgamal_pubkey in mint config but feature is disabled. Monero has viewing keys but incoming only, all-or-nothing. Zama has programmable ACL contracts. Tornado Cash had a voluntary report tool only."),
    # Cryptographic foundation
    ...
    ("Rich client-side proving", "ability to prove complex logic (multi-calls, full smart contract execution, atomic DeFi operations) privately on the user\u2019s device, verified cheaply on-chain. STRK20s: Cairo + Stwo prover enables proving entire Starknet block logic client-side. sub-5-second flow. Aztec: Noir + PXE executes private functions client-side in browser with ZK proofs. Aleo: Leo programs execute off-chain on client with ZK proofs, but no composability between private programs limits multi-step atomic operations. Zcash: limited to simple shielded transfers. Tornado Cash: \u201CI have enough funds\u201D was the ceiling. Railgun: bounded proof complexity. Solana: not succinctly verifiable. Zama: server-side FHE on coprocessors. Canton: no ZK proving, privacy via access control."),
    # Ecosystem & access
...
mkt_definitions = [
    ("Private by design",
     ...
     "multi-asset privacy pool + formally ZK proofs + secretless + efficient note discovery + rich client-side proving"),
    ("Composable funds",
    ...
    ("Fast to use",
     ...
     "fast shield/unshield + fast proof generation + scalable private transactions"),
    ("Compliance ready",
     "institutions and regulated entities can use the protocol legally. selective disclosure lets auditors trace a specific user\u2019s history without affecting anyone else\u2019s privacy.",
...
wb.save('privacy_feature_grid.xlsx')
print("Done")
